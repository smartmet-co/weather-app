...
const WarningSymbol: React.FC<WarningSymbolProps> = ({
  ...
  const typeMap: { [key in WarningType]: string } = {
    ...
    'Aviso por perturbació': 'disturbance-advisory',
    'Advertencia por perturbación': 'disturbance-watch',
    'Alerta por perturbación': 'disturbance-warning',
    'Aviso de depresión tropical': 'tropical-depression-advisory',
    'Advertencia por depresión tropical': 'tropical-depression-watch',
    'Alerta de depresión tropical': 'tropical-depression-warning',
    'Aviso de tormenta tropical': 'tropical-storm-advisory',
    'Advertencia por tormenta tropical': 'tropical-storm-watch',
    'Alerta de tormenta tropical': 'tropical-storm-warning',
    'Aviso de huracán': 'hurricane-advisory',
    'Advertencia por huracán': 'hurricane-watch',
    'Alerta de huracán': 'hurricane-warning',
    'Aviso por ciclón pos-tropical': 'post-tropical-cyclone-advisory',
    'Advertencia por por ciclón pos-tropical': 'post-tropical-cyclone-watch',
    'Alerta por ciclón pos-tropical': 'post-tropical-cyclone-warning',
    ...
    'Aviso por niveles alto': 'high-river-level-advisory',
    'Advertencia por niveles altos': 'high-river-level-watch',
    'Alerta por niveles alto': 'high-river-level-warning',
